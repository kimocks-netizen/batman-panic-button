(function() {
    ...
    var defaults = {
      phoneNumber: '',
      defaultMessage: 'Hello, I need assistance',
      buttonColor: '#25D366',
      position: 'right',
    ...
    WhatsAppWidget.prototype.init = function() {
      ...
      button.addEventListener('click', function() {
        var encodedMessage = encodeURIComponent(this.config.defaultMessage);
        window.open(
    ...
    window.WhatsAppWidget = {
      init: function(config) {
        return new WhatsAppWidget(config || window.whatsappWidgetConfig || {});
      }
    };
